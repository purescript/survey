...
## Welcome to the PureScript Survey! 欢迎参加PureScript社区调查
...
### Do you use PureScript? 你现在使用PureScript吗？

Select one. 请选择一个最合适的描述。
...
## For previous PureScript users 过去使用过PureScript的用户

### As you have indicated that you're no longer using PureScript, what prompted you to participate in this survey? 在你已经不使用PureScript的情况下，是什么原因驱使你参与这次调查？

Select all that apply. 请选择所有符合的选项。
...
### What issues in the PureScript ecosystem do you feel need the most urgent attention? 你觉得在PureScript生态中，哪些是最亟待解决的问题？
